...
namespace YZQ.Utility.HttpClientUtils
{
    ...
    /// </summary>
    public sealed class SandClient : YZQ.Utility.HttpClientUtils.BaseClient
    {
        private static readonly object lockHelper_SandClient = new object();
